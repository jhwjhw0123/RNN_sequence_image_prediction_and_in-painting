...
Flag_sigle_layer_LSTM = 32 # 64, 128
...
if Flag_sigle_layer_LSTM == 32:
    rnn_size = 32
    restore_dict = '../../Model/model_32_GRU/ImagePrediction.checkpoint'
elif Flag_sigle_layer_LSTM == 64:
    rnn_size = 64
    restore_dict = '../../Model/model_64_GRU/ImagePrediction.checkpoint'
elif Flag_sigle_layer_LSTM == 128:
    rnn_size = 128
    restore_dict = '../../Model/model_128_GRU/ImagePrediction.checkpoint'
...
def Recurrent_neural_network(x):
    ...
    All_Outputs, All_States =tf.contrib.rnn.static_rnn(GRU_cell,Data_Processed,dtype=tf.float32)
