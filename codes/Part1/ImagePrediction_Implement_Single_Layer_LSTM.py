...
Flag_sigle_layer_LSTM = 128  # 64, 128
...
chunck_size = 1
n_chunks = 784
if Flag_sigle_layer_LSTM == 32:
    rnn_size = 32
    restore_dict = '../../Model/model_32_tf_1_0/ImagePrediction.checkpoint'
elif Flag_sigle_layer_LSTM == 64:
    rnn_size = 64
    restore_dict = '../../Model/model_64_tf_1_0/ImagePrediction.checkpoint'
elif Flag_sigle_layer_LSTM == 128:
    rnn_size = 128
    restore_dict = '../../Model/model_128_tf_1_0/ImagePrediction.checkpoint'
...
def Implement_neural_network(x):
    ...
    with tf.Session() as sess:
        ...
        print('The Train loss of LSTM 32 cell is', loss.eval(train_dict))
        print('The Test loss of LSTM 32 cell is',loss.eval(test_dict))
